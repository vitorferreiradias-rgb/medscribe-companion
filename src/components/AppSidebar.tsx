    ...
    <Sidebar className="glass-sidebar border-r border-border/40">
      <SidebarHeader className="px-5 py-6">
        <div className="flex items-center gap-2.5">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-primary to-indigo text-primary-foreground text-sm font-bold shadow-md shadow-primary/20">
            M
          </div>
