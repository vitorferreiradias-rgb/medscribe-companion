const SOAP_URL = `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/generate-soap`;
...
export async function streamGenerateSoap({
  input,
  onDelta,
  onDone,
  onError,
  ...
  try {
    ...
    console.error("streamGenerateSoap error:", e);
